...
<body>
    ...
    <div class="table-data">
        <div class="order">
            <div class="head">
                <form id="categoryForm" action="" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <table class="rtable">
                        <tr>
                            <td>Title</td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <span class="error" id="featuredError"></span>
                            </td>
                        </tr>
                        <tr>
                            <td>Active</td>
                            <td>
                                ...
                                <span class="error" id="activeError"></span>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2">
    ...
    <script>
        function validateForm() {
            ...
            if (!featured) {
                document.getElementById('featuredError').innerHTML = "Please select an option for Featured.";
                isValid = false;
            }
            ...
            if (!active) {
                document.getElementById('activeError').innerHTML = "Please select an option for Active.";
                isValid = false;
            }
    ...
    if(isset($_POST['submit'])) {
        ...
        if(!$res) {
            echo "<script>alert('Failed to add category. Error: " . mysqli_error($conn) . "');</script>";
        } else {
            echo "<script>alert('Category added successfully.'); window.location.href='manage-category.php';</script>";
        }
    }
    ?>
</main>
