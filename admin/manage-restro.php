    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="manage-restro.php">All Restro Information</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <table>
                ...
                if ($count > 0) {
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        $food_licence_image = $row['food_licence_image'];
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                $food_licence_path = "../restro/$food_licence_image";
                                if (file_exists($food_licence_path) && !empty($food_licence_image)) {
                                    echo "<img src='$food_licence_path' alt='Food Licence' style='width: 100px; height: auto; border: 1px solid #ccc; cursor: pointer;' onclick='openModal(\"$food_licence_path\")'>";
                                } else {
                                    echo "<p>No Image</p>";
                                }
                                ?>
                            ...
                            <td>
                                <?php 
                                $restro_image_path = "../restro/$restro_image";
                                if (file_exists($restro_image_path) && !empty($restro_image)) {
                                    echo "<img src='$restro_image_path' alt='Restro Image' style='width: 100px; height: auto; border: 1px solid #ccc;'>";
                                } else {
                                    echo "<p>No Image</p>";
                                }
                                ?>
                            ...
                            <td>
                                <?php if ($status == 'not_approved') { ?>
                                    <a href="update-restro-status.php?id=<?php echo $id; ?>&action=approve" class="button-5">Approve</a>
                                <?php } ?>
                             
                                <?php if ($user_role == 1) { ?>
                                    <a href="update-restro-status.php?id=<?php echo $id; ?>&action=block" class="button-7">Block</a>
                                <?php } else { ?>
                                    <a href="update-restro-status.php?id=<?php echo $id; ?>&action=unblock" class="button-5">Unblock</a>
                                <?php } ?>
                            </td>
                        </tr>
                        <?php
                    ...
                    echo "<tr><td colspan='9' class='error'>No Restro Found</td></tr>";
                }
                ?>
            </table>
        </div>
