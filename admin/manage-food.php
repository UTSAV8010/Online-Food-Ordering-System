                ...
                if($count>0)
                {
                    while($row=mysqli_fetch_assoc($res))
                    {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo SITEURL; ?>update-food.php?id=<?php echo $id; ?>" class="button-5"
                                    role="button">Update</a>
                                <a href="<?php echo SITEURL; ?>delete-food.php?id=<?php echo $id; ?>&image_name=<?php echo $image_name; ?>"
