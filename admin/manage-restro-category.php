    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="manage-restro-category.php">Category</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <table class="">
                ...
                <?php 
                $sql = "SELECT * FROM tbl_rcategory_notapproved";
                ...
                if ($count > 0) {
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        $image_name = $row['image_name']; // Fetch image
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if ($image_name != "") { 
                                    ?>
                                    <img src="<?php echo SITEURL; ?>../restro/uploads/category/<?php echo $image_name; ?>" width="100" height="70" alt="Category Image">
                                    <?php 
                                } else {
                            ...
                            <td>
                                <?php if ($status == "not_approved") { ?>
                                    <a href="<?php echo SITEURL; ?>update-restro-category.php?id=<?php echo $id; ?>&action=approve" class="button-8" role="button">Approve</a>
                                <?php } ?>
                                <a href="<?php echo SITEURL; ?>update-restro-category.php?id=<?php echo $id; ?>&action=delete" class="button-7" role="button">Delete</a>
                            </td>
                        </tr>
                        <?php
                    }
                    ...
                    <tr>
                        <td colspan="8">
                            <div class="error">No Category Available</div>
                        </td>
                    </tr>
                    <?php
                }
