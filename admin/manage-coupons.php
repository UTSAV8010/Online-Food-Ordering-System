...
<body>
    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="manage-coupons.php">Coupons</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <!-- Button Add Coupon-->
    <a href="<?php echo SITEURL; ?>add-coupon.php" class="button-8" role="button">Add Coupons</a>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <table class="">
                ...
                <?php 
                // Fetching and displaying data from the coupon table
                ...
                if ($count > 0) {
                    ...
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo SITEURL; ?>update-coupon.php?id=<?php echo $id; ?>"
                                    class="button-5" role="button">Update</a>
                                <a href="<?php echo SITEURL; ?>delete-coupon.php?id=<?php echo $id; ?>"
                                    class="button-7" role="button">Delete</a>
                            </td>
                        </tr>
