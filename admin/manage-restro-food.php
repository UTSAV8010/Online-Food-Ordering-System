    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="manage-restro-food.php">Food Menu</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <table class="">
                ...
                <?php 
                    $sql = "SELECT * FROM tbl_restro_food_item";
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                            if($image_name != "") {
                                echo "<img src='".SITEURL."../restro/uploads/food/".$image_name."' width='100px'>";
                            } else {
                    ...
                    <td>
                        <?php if ($status == "not_approved") { ?>
                            <a href="<?php echo SITEURL; ?>update-restro-food.php?action=approve&id=<?php echo $id; ?>" class="button-8" role="button">Approve</a>
                        <?php } ?>
                        <a href="<?php echo SITEURL; ?>update-restro-food.php?action=delete&id=<?php echo $id; ?>" class="button-7" role="button">Delete</a>
                    </td>
                </tr>
                <?php
                        }
