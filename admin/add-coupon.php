...
<body>
    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li><i class='bx bx-chevron-right'></i></li>
                <li>
                    <a class="active" href="add-coupon.php">Add Coupon</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    if (isset($_POST['submit'])) {
        ...
        if ($res == true) {
            $_SESSION['add'] = "<div class='success text-center'>Coupon Added Successfully</div>";
            header('location:' . SITEURL . 'manage-coupons.php');
        } else {
            $_SESSION['add'] = "<div class='error text-center'>Failed to Add Coupon</div>";
            header('location:' . SITEURL . 'add-coupon.php');
        }
    }
    ?>
    <!-- Add Coupon Form End -->
...
<script>
    function validateForm() {
        ...
        const couponCode = document.getElementsByName("coupon_code")[0].value;
