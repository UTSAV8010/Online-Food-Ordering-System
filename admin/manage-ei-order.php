            ...
            <div class="head-title">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a class="active" href="manage-ei-order.php">User's Information</a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <table class="">
                        ...
                        <?php 
                        //Adding user_role column in query
...
$sn = 1; //Create a Serial Number and set its initail value as 1
                        ...
                        <tr>
                            ...
                            <td><?php echo $city; ?></td>
                            <td><span class="status process"><?php echo $phone; ?></span></td>
                            <td><?php echo $username; ?></td>
                            <td><?php echo $user_role == 1 ? 'Active' : 'Blocked'; ?></td>
                            <td class="table-actions">
                                <?php if($user_role == 1) { ?>
                                    <a href="<?php echo SITEURL; ?>update-user-role.php?id=<?php echo $id; ?>&role=0" class="button-5" role="button">Block</a>
                                <?php } else { ?>
                                    <a href="<?php echo SITEURL; ?>update-user-role.php?id=<?php echo $id; ?>&role=1" class="button-5" role="button">Unblock</a>
                                <?php } ?>
                        ...
                        {
                            //Users not Available
                            echo "<tr><td colspan='8' class='error'>Users not Available</td></tr>";
                        }
                        ?>
                    </table>
                </div>
