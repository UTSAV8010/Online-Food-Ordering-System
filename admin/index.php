...
$orders_delivered = "SELECT * FROM online_orders_new o
                     JOIN order_manager om ON o.order_id = om.order_id
                     WHERE o.restro_name = 'Pasar Kita' 
	...
	<script type="text/javascript">
      ...
      function drawSalesBarChart() {
        ...
        const options = {
          ...
          tooltip: {
            textStyle: { color: theme.panelText },
            showColorCode: true
          }
        };
...
<body>
	...
	<!-- SIDEBAR -->
	 ...
	 <!-- Dynamic Dashborad --> 
			...
			$admin_initial = strtoupper(substr(trim((string)$admin_name), 0, 1));
			if ($admin_initial === '') {
				$admin_initial = 'A';
			}
...
<div class="dashboard-grid">
  <a href="manage-category.php" class="kpi-card kpi-card-blue">
    <div class="kpi-media">
      <img src="../images/inventory.png" alt="Categories">
      <span class="kpi-badge">Live</span>
    </div>
    <div class="kpi-meta">
      <h3 class="kpi-value" id="kpi-categories"><?php echo number_format((int)$row_cat); ?></h3>
  ...
  <a href="monthly-revenue.php" class="kpi-card kpi-card-gold">
    ...
    <div class="kpi-meta">
      <h3 class="kpi-value" id="kpi-revenue">Rs <?php echo number_format((float)($total_revenue['total_amount'] ?? 0), 2); ?></h3>
      <p class="kpi-label">Revenue Generated</p>
    </div>
  </a>

  <a href="manage-online-order.php?status=Delivered" class="kpi-card kpi-card-violet">
    <div class="kpi-media">
      <img src="../images/orders_completed.png" alt="Orders Completed">
      <span class="kpi-badge">Live</span>
    </div>
    <div class="kpi-meta">
      <h3 class="kpi-value" id="kpi-orders"><?php echo number_format((int)$total_orders_delivered); ?></h3>
      <p class="kpi-label">Orders Completed</p>
    </div>
  </a>

  <a href="manage-food.php" class="kpi-card kpi-card-red">
    <div class="kpi-media">
      <img src="../images/folder2.png" alt="Menu Items">
      <span class="kpi-badge">Live</span>
    </div>
    <div class="kpi-meta">
      <h3 class="kpi-value" id="kpi-menu"><?php echo number_format((int)$row_item); ?></h3>
      <p class="kpi-label">Menu Items</p>
    </div>
  </a>
</div>
...
<div class="dashboard-charts">
  <div class="chart-panel">
    <div class="panel-head">
      ...
      <span class="panel-chip">Live Data</span>
    </div>
  ...
  <div class="chart-panel">
    <div class="panel-head">
      <h3>Sales By Day</h3>
      <span class="panel-chip" id="sales-chip">Last 7 days</span>
    </div>
