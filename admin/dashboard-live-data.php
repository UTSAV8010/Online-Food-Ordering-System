...
$categories = (int)fetchSingleValue($conn, "SELECT COUNT(*) AS total FROM tbl_category", 'total', 0);
$menuItems = (int)fetchSingleValue($conn, "SELECT COUNT(*) AS total FROM tbl_food", 'total', 0);
