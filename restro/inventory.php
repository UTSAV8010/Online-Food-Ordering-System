...
$low_only = isset($_GET['low']) && $_GET['low'] === '1';
$page_title = $low_only ? 'Low Stock Items' : 'Inventory';
$inventory_link = 'inventory.php' . ($low_only ? '?low=1' : '');
    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="<?php echo $inventory_link; ?>"><?php echo htmlspecialchars($page_title); ?></a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <table class="">
                ...
                <?php  
				 $restroname=$_SESSION['restro-name'];
                $stock_filter_sql = $low_only ? " AND stock<=$low_stock_threshold" : "";
                $sql = "SELECT * FROM tbl_restro_food_item where restro_name='$restroname'$stock_filter_sql";
                ...
                if($count > 0) {
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if($image_name == "") {
                                    ...
                                    ?>
                                    <img src="<?php echo SITEURL; ?>uploads/food/<?php echo $image_name; ?>" width="100px">
                                    <?php
                                }
                                ?>
                            </td>
                            <td>
                                ...
                                if ($stock_value <= $low_stock_threshold) {
                                    echo "<span class='status pending'>Out of stock</span>";
                                } else {
                                    echo "<span class='status completed'>In stock</span>";
                                }
                                ?>
                            </td>
                            <td>
                    ...
                    echo "<tr><td colspan='4' class='error text-center'>No Food Items Available</td></tr>";
                }
                ?>
            </table>
        </div>
