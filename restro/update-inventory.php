    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="clickable" href="inventory.php">Manage Inventory</a>
                </li>
                <li><i class='bx bx-chevron-right'></i></li>
                <li>
            ...
            <div class="head">
                ...
                <script>
                    function validateForm() {
                        let isValid = true;
                        let itemName = document.getElementsByName("Item_Name")[0];
                        let stock = document.getElementsByName("stock")[0];
                        let itemNameError = document.getElementById("item-name-error");
                        ...
                        if (stock.value.trim() === "" || isNaN(stock.value) || stock.value < 0 ) {
                            stockError.innerHTML = "Valid stock value is required";
                            isValid = false;
                        }
...
if(isset($_POST['submit'])) {
    ...
    $sql = "UPDATE tbl_restro_food_item SET title = '$Item_Name', stock = '$stock' WHERE id='$id'";
    $res = mysqli_query($conn, $sql);
