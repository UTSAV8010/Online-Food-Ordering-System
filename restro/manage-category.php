    ...
    <div class="head-title">
        <div class="left">
            ...
            <ul class="breadcrumb">
                ...
                <li>
                    <a class="active" href="manage-category.php">Category</a>
                </li>
            </ul>
        </div>
    </div>
    ...
    <div class="table-data">
        <div class="order">
            ...
            <table class="">
                ...
                <?php 
                $restroname = $_SESSION['restro-name'];
                $sql = "SELECT * FROM tbl_rcategory_notapproved WHERE restro_name='$restroname'";
                ...
                if ($count > 0) {
                    while ($row = mysqli_fetch_assoc($res)) {
                        ...
                        <?php 
                            if($image_name != "") {
                                echo "<img src='".SITEURL."uploads/category/".$image_name."' width='100px'>";
                            } else {
                        ...
                        ?>
                            ...
                            <td>
                                <a href="<?php echo SITEURL; ?>update-category.php?id=<?php echo $id; ?>" class="button-8" role="button">Update</a>
                                <a href="<?php echo SITEURL; ?>delete-category.php?id=<?php echo $id; ?>" class="button-7" role="button">Delete</a>
                            </td>
                        </tr>
                        <?php
                    }
